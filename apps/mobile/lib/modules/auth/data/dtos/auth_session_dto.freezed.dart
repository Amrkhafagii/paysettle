...
class _$AuthSessionDtoImpl implements _AuthSessionDto {
  ...
  @override
  String toString() {
    return 'AuthSessionDto(accessToken: $accessToken, refreshToken: $refreshToken, expiresAt: $expiresAt, user: $user)';
  }
...
abstract class _AuthSessionDto implements AuthSessionDto {
  const factory _AuthSessionDto(
      ...
      required final AuthUserDto user}) = _$AuthSessionDtoImpl;
